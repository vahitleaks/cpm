...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#9ba7ca"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#4d79f6", "#4d79f6", "#4ac7ec"], 'array', ','),
  ...
  if (obj.config.pointer) {
    ...
    obj.needle = obj.canvas.path().attr({
      ...
      "fill": (obj.config.pointerOptions.color !== null && obj.config.pointerOptions.color !== undefined) ? obj.config.pointerOptions.color : "#ff5da0",
      ndl: [
        obj.config.min,
        obj.config.min,
        obj.config.max,
