...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    noneSelectedText: 'Seçiniz',
      noneResultsText: 'Eşleşen sonuç yok {0}',
    countSelectedText: function (numSelected, numTotal) {
        return (numSelected == 1) ? '{0} kayıt seçildi' : '{0} kayıt seçildi';
    },
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      drop =
        '<div class="dropdown bootstrap-select col-12 p-0' + showTick + inputGroup + '">' +
  ...
  function Plugin (option) {
    ...
    if (version.major === '4') {
      ...
      classNames.SHOW = 'show';
        ...
        classNames.BUTTONCLASS = 'DropdownSearch';
