...
function changeTheme() {
    let themeVal = document.querySelector('input[name="iTheme"]').checked ? 'light' : 'dark';
    document.documentElement.setAttribute('theme', themeVal);
    window.location.href = "/ThemaLanguage/ChangeThema?themaName=" + themeVal;
}

function toggleClass(id) {
    var element = document.getElementById(id);
    if (element.className == 'sc-sun') {
        element.className = 'sc-night';
        element.style.color = "var(--thBlue)";
    } 
    else {
        element.className = 'sc-sun';
        element.style.color = "var(--thYellow)";
    }
}
